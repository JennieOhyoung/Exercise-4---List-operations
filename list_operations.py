...
def custom_insert(input_list, index, value):
    ...
    # new_list.append(input_list[index+1:])
    # # return new_list
...
def custom_equality(some_list, another_list):
    ...
    """
    # for i in some_list:
    #     if some_list[i] == another_list[i] and len(some_list) == len(another_list):
    #         return True
